...
def raze_fetch_remote_crates():
    ...
    _new_http_archive(
        ...
        type = "tar.gz",
        sha256 = "d9a60d744a80c30fcb657dfe2c1b22bcb3e814c1a1e3674f32bf5820b570fbff",
    ...
    _new_http_archive(
        ...
        type = "tar.gz",
        sha256 = "725cf19794cf90aa94e65050cb4191ff5d8fa87a498383774c47b332e3af952e",
        strip_prefix = "hermit-abi-0.1.10",
        build_file = Label("//cargo/remote:hermit-abi-0.1.10.BUILD.bazel")
    )
    ...
    _new_http_archive(
        ...
        type = "tar.gz",
        sha256 = "dea0c0405123bba743ee3f91f49b1c7cfb684eef0da0a50110f758ccf24cdff0",
        strip_prefix = "libc-0.2.68",
        build_file = Label("//cargo/remote:libc-0.2.68.BUILD.bazel")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:num-rational-0.2.4.BUILD.bazel")
    )
    ...
    _new_http_archive(
        name = "raze__regex__1_3_6",
        url = "https://crates-io.s3-us-west-1.amazonaws.com/crates/regex/regex-1.3.6.crate",
        type = "tar.gz",
        sha256 = "7f6946991529684867e47d86474e3a6d0c0ab9b82d5821e314b1ede31fa3a4b3",
        strip_prefix = "regex-1.3.6",
        build_file = Label("//cargo/remote:regex-1.3.6.BUILD.bazel")
    )
    ...
    _new_http_archive(
        name = "raze__thiserror__1_0_14",
        url = "https://crates-io.s3-us-west-1.amazonaws.com/crates/thiserror/thiserror-1.0.14.crate",
        type = "tar.gz",
        sha256 = "f0570dc61221295909abdb95c739f2e74325e14293b2026b0a7e195091ec54ae",
        strip_prefix = "thiserror-1.0.14",
        build_file = Label("//cargo/remote:thiserror-1.0.14.BUILD.bazel")
    )

    _new_http_archive(
        name = "raze__thiserror_impl__1_0_14",
        url = "https://crates-io.s3-us-west-1.amazonaws.com/crates/thiserror-impl/thiserror-impl-1.0.14.crate",
        type = "tar.gz",
        sha256 = "227362df41d566be41a28f64401e07a043157c21c14b9785a0d8e256f940a8fd",
        strip_prefix = "thiserror-impl-1.0.14",
        build_file = Label("//cargo/remote:thiserror-impl-1.0.14.BUILD.bazel")
    )
    ...
    _new_http_archive(
        name = "raze__winapi_util__0_1_4",
        url = "https://crates-io.s3-us-west-1.amazonaws.com/crates/winapi-util/winapi-util-0.1.4.crate",
        type = "tar.gz",
        sha256 = "fa515c5163a99cc82bab70fd3bfdd36d827be85de63737b40fcef2ce084a436e",
        strip_prefix = "winapi-util-0.1.4",
        build_file = Label("//cargo/remote:winapi-util-0.1.4.BUILD.bazel")
    )
